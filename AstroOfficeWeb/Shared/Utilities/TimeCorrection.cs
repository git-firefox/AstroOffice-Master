...
namespace AstroOfficeWeb.Shared.Utilities
{
    public class TimeCorrection
    {
            ...
            while (true)
            {
                ...
                if (strArrays.Length <= 1 ? false : string_1 != null)
                {
                    ...
                    if (dateTime.CompareTo(dateTime1) < 0)
                    {
                        ...
                        if (dateTime.CompareTo(dateTime1) >= 0)
                        {
                            int length = string_1.Length - 1;
                            while (length >= 0)
                            {
                                string string11 = string_1[length];
                                chrArray = new char[] { '/' };
                                ...
                                {
                                    empty = string_0[length];
                                    RetZone = string_2[length];
                                    break;
                                }
                            }
                        }
                    ...
                    {
                        empty = string_0[string_1.Length - 1];
                        RetZone = string_2[string_1.Length - 1];
                    }
                    if (empty.Length > 1)
                    {
                        MyTCor = empty;
        ...
        private string method_1(string string_3, string string_4)
        {
            ...
            {
                str = method_2(strArrays3[0].Substring(1), dateTime2.Year);
                chrArray = new char[] { '/' };
                strArrays = str.Split(chrArray);
                ...
                {
                    str = dateTime.Month <= Convert.ToInt32(strArrays3[1].Substring(3)) ? method_2(strArrays3[1].Substring(1), dateTime2.Year) : method_2(strArrays3[1].Substring(1), dateTime2.Year + 1);
                }
                else if (strArrays3[1].StartsWith("B"))
                {
                    str = dateTime.Month <= Convert.ToInt32(strArrays3[1].Substring(3)) ? method_4(strArrays3[1].Substring(1), dateTime2.Year) : method_4(strArrays3[1].Substring(1), dateTime2.Year + 1);
                }
                chrArray = new char[] { '/' };
                strArrays1 = str.Split(chrArray);
                if (strArrays1.Length < 3)
                {
                    chrArray = new char[] { '-' };
                    strArrays1 = str.Split(chrArray);
                }
            ...
            {
                str = method_4(strArrays3[0].Substring(1), dateTime2.Year);
                chrArray = new char[] { '/' };
                strArrays = str.Split(chrArray);
                dateTime = new DateTime(Convert.ToInt32(strArrays[2]), Convert.ToInt32(strArrays[1]), Convert.ToInt32(strArrays[0]));
                if (strArrays3[1].StartsWith("A"))
        ...
        private string method_2(string string_3, int int_0)
        {
            ...
            DayOfWeek dayOfWeek = method_3(num2);
            if (num1 >= 6)
            {
