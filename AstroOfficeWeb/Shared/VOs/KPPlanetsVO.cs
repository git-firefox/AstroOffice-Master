...
namespace AstroOfficeWeb.Shared.VOs
{
    public class KPPlanetsVO
    {
        ...
        public string Shatru
        {
            get;
            set;
        }

        public string Shreshth
        {
            get;
            set;
        }
